...
<ul>
   ...
   <li><a href='withdraw.php'><span>withdraw</span></a></li>
	...
	<form action="income.php" method="post">
				<p class="heading_narrow">Fill the form bellow to Enter income data.</p>
				<table>
				<tr>
				<td>receiptNo:</td>
				...
				<tr>
				<td>typeOfIncome:</td>
				<td><input type="text" name="ddate"  required/></td>
				
				</tr>
				<tr>
				<td>receivedFrom</td>
				<td><input type="text" name="dpaid"  required/></td>
				</tr>
				<tr>
				<td>incomeAmount</td>
				<td>
	...
	$teller=$_POST['teller'];
	$date=$_POST['date'];
	$a=mysqli_query($con,"insert into income(receiptNo,typeOfIncome,receivedFrom,incomeAmount,date)
	 values('$damt','$ddate','$dpaid','$teller','$date')");
	 if($a){
